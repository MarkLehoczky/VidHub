...
namespace VidHub.Core.Models
{
    public class Tag : ObservableObject
    {
        ...
        public bool ColorPickerOpen { get => colorPickerOpen; set { SetProperty(ref colorPickerOpen, value); OnPropertyChanged(nameof(ColorPickerIcon)); } }
        public string ColorPickerIcon => ColorPickerOpen ? "\ue70d" : "\ue70e";
    }
}
